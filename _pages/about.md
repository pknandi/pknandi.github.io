...
I am Pranjal Kumar Nandi, a Machine Learning Engineer working in a US-Based Software Company in Dhaka, Bangladesh. I completed my Bachelor of Science (B.Sc.) degrees in Computer Science and Engineering (CSE) from Department of Computer Science and Engineering, [University of Dhaka (DU)](https://www.du.ac.bd/), Dhaka, Bangladesh. My research interests include, but are not limited to Internet of Things (IoT), Machine Learning, Computer Vision, Wireless Sensor Networks, Edge Intelligence, IoT Security, Game Theory, Cyber-Physical Systems and Smart City Applications.
